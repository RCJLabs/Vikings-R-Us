...
* ["Isn't that unfair on the ones who were ambushed?"]
  "Very. Write to Odin." # speaker: skogul
  She doesn't say where to send the letter.
* ["Understood."]
  "You'll learn to see it in how they stand. Cowards stand very straight when they're dead." # speaker: skogul
  # fx: standing odin +1
- The queue shuffles forward. Somebody near the back is trying very hard not to turn around.
-> END
