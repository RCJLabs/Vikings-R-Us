 ...
 *   pnpm sim campaign [--seeds 200] [--target dev-full|web-demo] [--story plain,ferry,…|all]
...
if (cmd === 'campaign') {
  ...
  const reports = simulateCampaign(loadContent(target), seeds, JUDGING, strategies, stories, loadScenes(target));
  console.log(
