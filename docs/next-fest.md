...
The decision the build plan puts at the end of M5. Each game gets one Steam Next Fest, so the choice is June or October 2027.

## What's known

From the build plan's sources (Valve's Next Fest pages, checked when the plan was written):

- **June 2027** runs June 14–21. Registration closes April 25, and the demo and store page must be in review by May 17.
- **October 2027** dates weren't announced. It's usually mid-October, with registration about two months before.
- The demo should be public 2–4 weeks before the fest.
- The Steam Direct fee starts a 30-day wait before release, and the store page must be reviewed before it goes public.
...
The engineering in items 3 and 4 is about three weeks of M6. Items 1 and 2 decide the date.
...
- A fest with a weak demo spends the one chance.
- Wishlists grow with the months a store page is up before the fest (general indie experience, not data from this project), and October gives the page longer.
