...
| Family trouble money can't fix, part 1 (after M7: gameplay item 6): Ragna's chest and the hill past the falls (Night 10, and the last chance on Night 13); the mornings she's carried up (Days 11 and 14); Móðguðr's news if she wasn't (Night 14); her letter after (Night 15) | scenes `d10.night.ink`, `d13.night.ink`, `d11.morning.ink`, `d14.morning.ink`, `d14.night.ink`, `d15.night.ink`; campaign string `speaker.bera` | ~590 |
| Family trouble money can't fix, part 2 (after M7: gameplay item 6): the levy and Ulf's wish to go (Night 15), Kari Solveigarson at the desk (Day 16, three lines and his plea), the levy home (Night 16) | scenes `d15.night.ink`, `d16.night.ink`; `content/packs/campaign/cases/kari.yaml`; campaign strings `case.kari.*` | ~480 |
...
| The endings and the epilogue (after the rundown, item 1): the nine campaign endings rewritten as short scenes, and what became of the family, the powers and the story's own souls (docs/tech-spec.md §55). `pnpm story:script` shows every line with its condition | campaign strings `ending.*.text`, `epi.*`; core `ui.epilogue.*`; `epilogue` in `content/packs/campaign/campaign.yaml` | ~3,000 |
| Rings with a late job, and a softer bottom (after the rundown, item 3): the four lots of arms for the last battle, Skögul's reprieve and her word of it on the last night, the market's words for arms and selling back (docs/tech-spec.md §56) | campaign strings `arms.*`; demo string `reprieve.text`; scene `d19.night.ink`; core `ui.arms.*`, `ui.shop.*`, `ui.night.reprieve`, `ui.ragnarok.arms` | ~250 |
| Loki's favour and the clerk's contract kept (after the rundown, item 6): a ring a nail, its row at the audit, and the clerk's second offer on Day 19's morning (docs/tech-spec.md §57) | campaign strings `favour.loki`, `favour.loki.more`; core `ui.audit.nails`; scenes `d18.morning.ink` ("Not yet" now keeps it), `d19.morning.ink` | ~150 |
...
- **Day 10:** The clerk of the White Christ sets up his table. Shaking his hand is clerk +1. At night: the man baptized twenty times for the shirts. Help with the form (`helped_clerk`, clerk +1) or ask about his end of the table (`heard_pension`). If Ulf went north, Bard, a shipwright from his yard, is in the queue: drowned off the scaffold, nails long (story soul, RÁN, clipped first). Then your mother's letter (docs/tech-spec.md §50): her chest, which medicine won't mend, and a hill past the falls that mends any woman who climbs it (Lyfjaberg). Fly her up before dawn (`ragna_hill`, and Day 11's shift loses 2:00 of sun), send the healer silver (it comes back: "The hill doesn't come down."), or let her rest until the thaw (`ragna_waits`).
- **Day 11:** If you flew your mother up the hill, the morning opens with you coming down over the falls: Eir, one of the nine women on the hill, took her hands. Forged tallies and their three tells. At night a carver has been selling families better tallies for their dead; he offered one for Grandfather (or, if she's gone, for Mother). Tell the truth (`letters_honest`), ask for his name (`reported_carver`, Odin +1) or tell a kindness (`letters_kind`). If Asa is sick, a healer will cure her for the winter for 15 rings (`fx: family sister well`). Your mother has heard that a man from Ulf's shipyard fell into the fjord.
...
- **Day 13 (the midpoint twist):** If your mother is resting, the night's first letter is the last chance: the hill at first light, or she won't see another. Fly her up (`ragna_hill` = 2, and Day 14's shift loses 3:00 of sun) or write that you can't (`ragna_refused`: she dies in the night). Then both ravens report. At night Muninn tells you Odin woke the seeress and knows how it ends, his own death included. Ask what else she said (`truth` +1: "something green, after"), ask why Odin goes on (Odin +1), or ask whether Skögul knows. If you reported the carver, Bjarni is in the queue, drowned by the jarl and carrying his own forged tally (story soul, RÁN). If you let Loki through on Day 12, Skögul says he has a seat on Odin's benches (`loki_in_valhalla`). Muninn has forgotten what he came to say, but he remembers the jarl: his thirty rings on your table (`jarl_bribe`), or that you sent him to Hel anyway (`jarl_refused`).
- **Day 14:** If you flew your mother up at the last chance, the morning opens with it. Hel's hall is full and her straw deaths go to the clerk, who has "plenty of room" (offering help is clerk +1). If you helped him on Day 10, his twenty-shirt man has asked for a twenty-first (`helped_clerk`). At night Móðguðr, who keeps the bridge to Hel, says Hel is on strike until someone at the gate says the quiet dead count. If your mother died, Móðguðr crossed her over that morning: she asked the way to her father's bench, and Hel, who is letting nobody in, let her in. Ask about Grandfather (`truth` +1: he sits near Baldr, who walks out into the new world after the fire). Then side with Hel (`sided_hel`, Hel +2, Odin −1), with Odin (Odin +1, Hel −1), or neither.
- **Day 15:** Freyja asks you to send her the souls Odin now claims. Side with her (`sided_freyja`, Freyja +2, Odin −1), with the decree (`sided_odin`, Odin +2, Freyja −1), or with the Order. At night a ferryman at the fjord's mouth offers the family a shore the wolf won't reach (if your mother climbed the hill, her letter says her chest is quiet). Then the jarl's levy goes up to hold the pass (docs/tech-spec.md §51), and Solveig's boy, Kari, with it. If Ulf stayed home he wants to go too: let him (`ulf_levy`, Odin +1), pay the steward to strike his name (the rings come back: "I'm not a debt."), or keep him (`ulf_stayed`): 20 rings now (`ferryman`), 100 on the day, or wait (`ferryman_doubted`). If nobody reported the carver, Bjarni dies of old age and brings his forged tally to the gate; Hel's hall is full, so he's the clerk's (story soul, TRANSFER).
- **Day 16:** Liars forfeit the halls. Kari Solveigarson, second in line, died at the pass at sunrise and belongs in Valhalla; he asks, openly, for Rán, where his mother is (story soul; `kari_valhalla`, `kari_ran`, `kari_judged`). At night the levy comes home: Ulf with a hurt arm if he went (`fx: family brother sick`), or Kari's shield on a cart if he stayed; Bera knows where you sent Kari. Thorvald is in the queue, still alive (story soul, RETURN; `thorvald16_judged`, `thorvald16_returned`). At dusk he tells you about Hoddmímir's wood, where nothing finds you: ask about it and Skögul tells the song of the two who survive the fire (`truth` +1, `wood_known`). If you asked on Day 3 whether anyone comes back twice, she points him out (`asked_twice`).
...
Flags the drafts set: `told_skogul`, `kept_quiet`, `loki_judged`, `loki_detained`, `loki_in_valhalla`, `reported_loki`, `covered_loki` (Day 12); `asked_about_lies`, `asked_twice`, `asked_namesake`, `letters_kind`, `letters_honest`, `roof_mended`, `met_loki`, `promised_medicine`, `owes_skogul`; from Thorvald's stamps `thorvald_met`, `thorvald_returned`, `thorvald_valhalla`, `thorvald16_judged`, `thorvald16_returned`; from Geir's `geir_judged`, `geir_hel`, `geir_spared`; from the phase 2 souls' `hrolf_judged`, `solveig_judged`; Days 7–20: `ulf_fine_paid`, `ulf_debt`, `loki_deal`, `refused_loki`, `ulf_shipyard`, `ulf_home`, `helped_clerk`, `heard_pension`, `reported_carver`, `truth` (a count), `sided_hel`, `sided_freyja`, `sided_odin`, `ferryman`, `ferryman_doubted`, `wood_known`, `wood`, `stay_home`, `clerk_contract`, `broke_loki`; the family's troubles (docs/tech-spec.md §50, §51): `ragna_hill` (1 on Night 10, 2 at the last chance), `ragna_waits`, `ragna_refused`, `ulf_levy`, `ulf_stayed`, `kari_judged`, `kari_valhalla`, `kari_ran`. The endings read `loki_deal`, `truth`, `wood`, `ferryman` and `clerk_contract`; later scenes, threads and story souls' `when` read the rest. `pnpm story:script` lists any flag that's set but read nowhere; since phase 2 there are none.
...
# fx: family sister sick        (or: well; or gone, and an adult dies, a child goes to relatives)
# fx: sun -120                  (the next shift's sun, in seconds: a trip home at dawn)
```

`fx: sun` is for trouble that costs time instead of rings (docs/tech-spec.md §50). A night scene's lands on the next day's shift, a morning scene's on that day's. The option says so ("2:00 less sun tomorrow"), the morning says so, and the gate keeps two minutes of sun whatever it takes. There's no sun in Story Mode, so there it costs nothing.
...
- `# beat` starts a new part of the scene, for the notes (above).
